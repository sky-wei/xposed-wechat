...
import com.sky.xposed.wechat.data.config.WeConfig703;
...
public class VersionManager implements XVersionManager {
    ...
    static {
        // 微信版本配置
        CONFIG_MAP.put("7.0.3", WeConfig703.class);
    }
    ...
    private VersionManager(Build build) {
        ...
        PackageInfo packageInfo = PackageUtil
                .getPackageInfo(build.mContext, Constant.WeChat.PACKAGE_NAME, 0);
